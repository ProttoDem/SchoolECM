...
public class OrderAggregateTest
{
    ...
    public void Create_order_item_success()
    {
        ...
        //Act 
        var fakeOrderItem = new DisciplineItem(productId, productName, unitPrice, discount, pictureUrl, units);
    ...
    public void Invalid_number_of_units()
    {
        ...
        //Act - Assert
        Assert.ThrowsException<OrderingDomainException>(() => new DisciplineItem(productId, productName, unitPrice, discount, pictureUrl, units));
    }
    ...
    public void Add_new_Order_raises_new_event()
    {
        ...
        //Act 
        var fakeOrder = new Schedule("1", "fakeName", new Address(street, city, state, country, zipcode), cardTypeId, cardNumber, cardSecurityNumber, cardHolderName, cardExpiration);
