...
public sealed class CatalogApiTests : IClassFixture<CatalogApiFixture>
{
    ...
    public async Task GetCatalogItemsRespectsPageSize()
    {
        ...
        var result = JsonSerializer.Deserialize<PaginatedItems<Discipline>>(body, _jsonSerializerOptions);
    ...
    public async Task UpdateCatalogItemWorksWithoutPriceUpdate()
    {
        ...
        response.EnsureSuccessStatusCode();
        var body = await response.Content.ReadAsStringAsync();
        var itemToUpdate = JsonSerializer.Deserialize<Discipline>(body, _jsonSerializerOptions);
        ...
        var updatedItem = JsonSerializer.Deserialize<Discipline>(body, _jsonSerializerOptions);
    ...
    public async Task GetCatalogItemsbyIds()
    {
        ...
        response.EnsureSuccessStatusCode();
        var body = await response.Content.ReadAsStringAsync();
        var result = JsonSerializer.Deserialize<List<Discipline>>(body, _jsonSerializerOptions);
    ...
    public async Task GetCatalogItemWithId()
    {
        ...
        response.EnsureSuccessStatusCode();
        var body = await response.Content.ReadAsStringAsync();
        var result = JsonSerializer.Deserialize<Discipline>(body, _jsonSerializerOptions);
    ...
    {
        // Act - 1
        var bodyContent = new Discipline {
            Id = 10015,
            Name = "TestCatalog1",
        ...
        response.EnsureSuccessStatusCode();
        var body = await response.Content.ReadAsStringAsync();
        var addedItem = JsonSerializer.Deserialize<Discipline>(body, _jsonSerializerOptions);
