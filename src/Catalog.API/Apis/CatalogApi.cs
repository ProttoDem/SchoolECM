...
public static class CatalogApi
{
    public static IEndpointRouteBuilder MapCatalogApiV1(this IEndpointRouteBuilder app)
    {
        ...
        api.MapGet("/items/{disciplineId:int}/pic", GetItemPictureById);
    ...
    public static async Task<Results<NotFound, PhysicalFileHttpResult>> GetItemPictureById(CatalogContext context, IWebHostEnvironment environment, int disciplineId)
    {
        var item = await context.Disciplines.FindAsync(disciplineId);
