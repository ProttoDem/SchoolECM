...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity(" eShop.Ordering.Domain.AggregatesModel.OrderAggregate.Schedules", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity(" eShop.Ordering.Domain.AggregatesModel.OrderAggregate.Discipline", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity(" eShop.Ordering.Domain.AggregatesModel.OrderAggregate.Discipline", b =>
                {
                    b.HasOne(" eShop.Ordering.Domain.AggregatesModel.OrderAggregate.Schedules", null)
                        .WithMany("OrderItems")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
